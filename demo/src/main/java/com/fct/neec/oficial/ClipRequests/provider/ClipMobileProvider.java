package com.fct.neec.oficial.ClipRequests.provider;
...
import com.fct.neec.oficial.ClipRequests.provider.ClipMobileContract.Students;
import com.fct.neec.oficial.ClipRequests.provider.ClipMobileContract.Users;
import com.fct.neec.oficial.ClipRequests.provider.ClipMobileDatabase.Tables;
import com.fct.neec.oficial.ClipRequests.util.SelectionBuilder;
    ...
    private Uri insertInTransaction(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case STUDENTS_YEAR_SEMESTER: {
                ...
                newItemUri = ClipMobileContract.StudentsYearSemester.buildUri(String.valueOf(id));
                break;
            }
            case SCHEDULE_DAYS: {
                ...
                newItemUri = ClipMobileContract.ScheduleDays.buildUri(String.valueOf(id));
                break;
            }
            case SCHEDULE_CLASSES: {
                ...
                newItemUri = ClipMobileContract.ScheduleClasses.buildUri(String.valueOf(id));
                break;
            }
            case STUDENT_CLASSES: {
                ...
                newItemUri = ClipMobileContract.StudentClasses.buildUri(String.valueOf(id));
                break;
            }
            case STUDENT_CLASSES_DOCS: {
                ...
                newItemUri = ClipMobileContract.StudentClassesDocs.buildUri(String.valueOf(id));
                break;
            }
            case STUDENT_CALENDAR: {
                ...
                newItemUri = ClipMobileContract.StudentCalendar.buildUri(String.valueOf(id));
                break;
            }
